...
def uploadToGoogleDrive(nameCsv):
    headers = {"Authorization": "Bearer ya29.A0ARrdaM_iDjB7bPW-JsG1DE7CjmXnQaRahPrFVkls_iK5uxMgiwk8tVK_scEIN_vjzW8JVnu5Tk1t-XK6PVO0yb1tbYwDf3kd6tfl2BuWzz9Ov1d9i2HcHv5qUXBMEdOPWoi5RLB1IKWdZ6xPGYBnJCFBd3Vc"}
    #AUTORIZAÇÂO https://developers.google.com/oauthplayground/ >GOOGLE DRIVE API > ACESS TOKEN
    para = {
        "name":nameCsv,
        "parents":["113osm7ZaQrjJTnO0HKVDW8JnZ5z8hcc9"] #LINK PASTA GOOGLE DRIVE 
        #EXEMPLO : https://drive.google.com/drive/folders/113osm7ZaQrjJTnO0HKVDW8JnZ5z8hcc9
    }
    files = {
        'data': ('metadata', json.dumps(para), 'application/json; charset=UTF-8'),
        'file': open("./"+nameCsv+".csv", "rb") #SELECIONAR O ARQUIVO
    }
    r = requests.post(
